...
class DataSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id', 'character_name','create_date','cube_type', 'item_upgrade_result'
                  ...
                  'before_additional_potential_options_grade_1',
                  'before_additional_potential_options_value_1',
                  'before_additional_potential_options_grade_2',
                  'before_additional_potential_options_value_2',
                  'before_additional_potential_options_grade_3',
                  'before_additional_potential_options_value_3',
                  ...
                  'after_additional_potential_options_grade_1',
                  'after_additional_potential_options_value_1',
                  'after_additional_potential_options_grade_2',
                  'after_additional_potential_options_value_2',
                  'after_additional_potential_options_grade_3',
                  'after_additional_potential_options_value_3',
                  )